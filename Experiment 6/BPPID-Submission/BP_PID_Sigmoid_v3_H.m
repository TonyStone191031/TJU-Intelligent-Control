% This file differs from BP_PID_Sigmoid_v1.m in both the value of 'H' and
% the initialization of 'wi' and 'wo'.
...
wi = -0.50 * rand(H, IN); % 初始化隐含层权值 weight_input
wi_1 = wi; wi_2 = wi; wi_3 = wi;

wo = 0.50 * rand(OUT, H);    % 初始化输出层权值 weight_output
